...
class Article extends MY_Controller {
	 ...
	 public function addcategory(){
		...
		if($this->input->post('add')){
			...
			if($this->form_validation->run() == TRUE){
                $_post = $this->my_string->allow_post($_post,array('title','parentid','route','description','image','publish','meta_title','meta_keyword','meta_description'));
	...
	public function editcategory($id){
		...
		if($this->input->post('edit')){
			...
			if($this->form_validation->run() == TRUE){
                $_post = $this->my_string->allow_post($_post,array('title','parentid','image','route','description','publish','meta_title','meta_keyword','meta_description'));
