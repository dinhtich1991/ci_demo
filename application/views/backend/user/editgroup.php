				...
				<section class="main-panel main-panel-single">
					...
					<section class="block">
						...
						<section class="checkbox-radio">
							...
							<section class="group">
								<label>
									<input type="radio" name="data[allow]" value="1" <?php echo isset($_post['allow'])?(($_post['allow'] == 1)?'checked ="checked"':''):''; ?> /><span>Cho phép</span>
								</label>
								<label>
									<input type="radio" name="data[allow]" value="0" <?php echo isset($_post['allow'])?(($_post['allow'] == 0)?'checked ="checked"':''):''; ?> /><span>Không cho phép</span>
								</label>
							</section>
						</section>
						<label class="item">
							<p class="label">Nội dung:</p>
							<textarea name="data[group]" value="" class="txtTextarea" ><?php echo isset($_post['group'])?$_post['group']:''; ?></textarea>
						</label>
