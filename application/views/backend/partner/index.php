		...
		<section class="it-tabs">
			<h1>Đối tác</h1>
			<ul>
				<li class="active"><a href="backend/partner/index">Đối tác</a></li>
				<li><a href="backend/partner/add">Thêm đối tác</a></li>
			</ul>
		</section> <!--end tab-->
		<section class="it-view">
			<section class="advanced">
				<section class="search">
					<form method="get" action="backend/partner/index">
				...
				<table cellpadding="0" cellspacing="0" class="main">
					<thead>
						<tr>
							...
							<th><?php echo get_link_sort(array('base_url'=>$_config['base_url'],'field' =>'title','title' =>'Tên đối tác','page'=>$_page,'sort_field' =>$_sort['field'],'sort_value' =>$_sort['value'])); ?></th>
					...
					if(isset($_list) &&count($_list)){ 
						...
						<tr>
							...
							<td class="last"><a href="backend/partner/set/publish/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Trạng thái"><img src="public/template/backend/images/<?php echo ($valList['publish'] ==1)?'check':'uncheck'; ?>.png" title="Trạng thái"/></a></td>
							<td><a href="backend/partner/del/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Xóa" onclick="return confirm('Bạn Chắc Chắn Muốn Xóa?');"><img src="public/template/backend/images/delete.png" /></a><a href="backend/partner/edit/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Sửa"><img src="public/template/backend/images/setting.png" /></a></td>
