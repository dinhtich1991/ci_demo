		<section class="it-tabs">
			...
			<ul>
				...
				<li class="active"><a href="backend/article/additem" title="Thêm sản phẩm">Thêm sản phẩm</a></li>
			</ul>
		</section> <!--end tab-->
					...
					<section class="block">
						...
						<section class="container">
							...
							<section class="checkbox-radio">
								...
								<section class="group">
									<label>
										<input type="radio" name="data[hot]" value="1" <?php echo isset($_post['hot'])?(($_post['hot'] == 1)?'checked ="checked"':''):''; ?> /><span>Có</span>
									</label>
									<label>
										<input type="radio" name="data[hot]" value="0" <?php echo isset($_post['hot'])?(($_post['hot'] == 0)?'checked ="checked"':''):''; ?> /><span>Không</span>
									</label>
								</section>
							</section>
