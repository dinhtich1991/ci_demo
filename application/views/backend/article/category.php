				...
				<table cellpadding="0" cellspacing="0" class="main">
					...
					if(isset($_list) &&count($_list)){ 
						...
						<tr>
							...
							<td class="last"><a href="backend/article/setcategory/publish/<?php echo $valList['id']; ?>" title="Trạng thái"><img src="public/template/backend/images/<?php echo ($valList['publish'] ==1)?'check':'uncheck'; ?>.png" title="Trạng thái"/></a></td>
							<td><input type="input" name="order[<?php echo $valList['id']; ?>]" value="<?php echo $valList['order']; ?>" class="order" /></td>
							<td><a href="backend/article/delcategory/<?php echo $valList['id']; ?>" title="Xóa" onclick="return confirm('Bạn Chắc Chắn Muốn Xóa?');"><img src="public/template/backend/images/delete.png" /></a><a href="backend/article/editcategory/<?php echo $valList['id']; ?>" title="Sửa"><img src="public/template/backend/images/setting.png" /></a></td>
