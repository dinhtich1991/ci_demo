		...
		<section class="it-tabs">
			<h1>Menu phụ</h1>
			<ul>
				<li class="active"><a href="backend/submenu/index">Menu phụ</a></li>
				<li><a href="backend/submenu/add">Thêm Menu</a></li>
			</ul>
		</section> <!--end tab-->
		<section class="it-view">
			<section class="advanced">
				<section class="search">
					<form method="get" action="backend/submenu/index">
				...
				<table cellpadding="0" cellspacing="0" class="main">
					...
					if(isset($_list) &&count($_list)){ 
						...
						<tr>
							...
							<td class="last"><a href="backend/submenu/set/publish/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Trạng thái"><img src="public/template/backend/images/<?php echo ($valList['publish'] ==1)?'check':'uncheck'; ?>.png" title="Trạng thái"/></a></td>
							<td><a href="backend/submenu/del/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Xóa" onclick="return confirm('Bạn Chắc Chắn Muốn Xóa?');"><img src="public/template/backend/images/delete.png" /></a><a href="backend/submenu/edit/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Sửa"><img src="public/template/backend/images/setting.png" /></a></td>
