		...
		<section class="it-tabs">
			<h1>Bài viết cho BST</h1>
			<ul>
				<li class="active"><a href="backend/galary/bstdetail" title="Bài viết cho BST">Bài viết cho BST</a></li>
				<li><a href="backend/galary/addbstdetail" title="Thêm Bài viết cho BST">Thêm Bài viết cho BST</a></li>
			</ul>
		</section> <!--end tab-->
		<section class="it-view">
			<section class="advanced">
				<section class="search">
					<form method="get" action="backend/galary/bstdetail">
				...
				<table cellpadding="0" cellspacing="0" class="main">
					<thead>
						<tr>
							...
							<th><?php echo get_link_sort(array('base_url'=>$_config['base_url'],'field' =>'title','title' =>'Tên Bài viết cho BST','page'=>$_page,'sort_field' =>$_sort['field'],'sort_value' =>$_sort['value'], 'parentid' =>$_parentid, 'keyword' =>$_keyword)); ?></th>
							<th>Danh mục</th>
					...
					if(isset($_list) &&count($_list)){ 
						...
						<tr>
							...
							<td><?php $cate = get_category('galary_bst','id, title',array('id' => $valList['parentid'])); echo isset($cate['title'])?$cate['title']:''; ?></td>
							...
							<td class="last"><a href="backend/galary/setbstdetail/publish/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Trạng thái"><img src="public/template/backend/images/<?php echo ($valList['publish'] ==1)?'check':'uncheck'; ?>.png" title="Trạng thái"/></a></td>
							<td class="last"><a href="backend/galary/setbstdetail/highlight/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Nổi bật"><img src="public/template/backend/images/<?php echo ($valList['highlight'] ==1)?'check':'uncheck'; ?>.png" title="Nổi bật"/></a></td>
							<td class="last"><a href="backend/galary/setbstdetail/hot/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Hot"><img src="public/template/backend/images/<?php echo ($valList['hot'] ==1)?'check':'uncheck'; ?>.png" title="Hot"/></a></td>
							<td><a href="backend/galary/delbstdetail/<?php echo $valList['id'];?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Xóa" onclick="return confirm('Bạn Chắc Chắn Muốn Xóa?');"><img src="public/template/backend/images/delete.png" /></a><a href="backend/galary/editbstdetail/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Sửa"><img src="public/template/backend/images/setting.png" /></a></td>
