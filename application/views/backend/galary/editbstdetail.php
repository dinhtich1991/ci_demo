					...
					<section class="block">
						...
						?>
								<label class="item">
									...
									<input type="text" name="data[image][<?php echo $so; ?>]" value="<?php echo isset($val)?$val:''; ?>" class="txtText" id="txtImage<?php echo $so; ?>" />
									<input type="button" value="Chọn ảnh" class="btnButton" onclick="browseKCFinder('txtImage<?php echo $so; ?>','image'); return FALSE;" />
								</label>
						<?php
								$so = $so + 1;
								}
