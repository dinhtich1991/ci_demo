		<section class="it-tabs">
			...
			<ul>
				<li><a href="backend/galary/bst" title="bộ sưu tập">Bộ sưu tập</a></li>
				<li class="active"><a href="backend/galary/addbst" title="Thêm bộ sưu tập">Thêm bộ sưu tập</a></li>
			</ul>
		</section> <!--end tab-->
			...
			<form method="post" action="">
				<section class="main-panel">
					...
					<section class="block">
						...
						<label class="item">
							<p class="label">bộ sưu tập cha:</p>
