		...
		<section class="it-tabs">
			<h1>Quảng cáo</h1>
			<ul>
				<li class="active"><a href="backend/adv/index">Quảng cáo</a></li>
				<li><a href="backend/adv/add">Thêm quảng cáo</a></li>
			</ul>
		</section> <!--end tab-->
				...
				<table cellpadding="0" cellspacing="0" class="main">
					<thead>
						<tr>
							...
							<th><?php echo get_link_sort(array('base_url'=>$_config['base_url'],'field' =>'title','title' =>'Tên quảng cáo','page'=>$_page,'sort_field' =>$_sort['field'],'sort_value' =>$_sort['value'])); ?></th>
					...
					if(isset($_list) &&count($_list)){ 
						...
						<tr>
							...
							<td class="last"><a href="backend/adv/set/publish/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Trạng thái"><img src="public/template/backend/images/<?php echo ($valList['publish'] ==1)?'check':'uncheck'; ?>.png" title="Trạng thái"/></a></td>
							<td><a href="backend/adv/del/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Xóa" onclick="return confirm('Bạn Chắc Chắn Muốn Xóa?');"><img src="public/template/backend/images/delete.png" /></a><a href="backend/adv/edit/<?php echo $valList['id']; ?>?continue=<?php echo base64_encode(common_fullurl()); ?>" title="Sửa"><img src="public/template/backend/images/setting.png" /></a></td>
