...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2015 at 09:11 AM
...
(1, 'Root', '', '', 0, '', 0, 0, 0, 3, '', 0, 0, 'all', '', '', '', 6, 0, '2015-08-08 17:30:05', '0000-00-00 00:00:00'),
...
('10ed90bd765d92a1a160a78b98727ad4', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.155 Safari/537.36', 1439865852, 'a:2:{s:9:"user_data";s:0:"";s:5:"_lang";s:2:"vi";}'),
('456e912cb6c8c7714117e1933e473cad', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.155 Safari/537.36', 1439865929, 'a:2:{s:9:"user_data";s:0:"";s:5:"_lang";s:2:"vi";}'),
('486211b4ed0a604182edeb3b7147f805', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.155 Safari/537.36', 1439881874, 'a:2:{s:9:"user_data";s:0:"";s:5:"_lang";s:2:"vi";}'),
('663130ce6e28c23e46d014b5820935a3', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.155 Safari/537.36', 1439865981, 'a:2:{s:9:"user_data";s:0:"";s:5:"_lang";s:2:"vi";}'),
('6a0f74c25f9fb134523b345d2711ab47', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.155 Safari/537.36', 1439865844, 'a:2:{s:9:"user_data";s:0:"";s:5:"_lang";s:2:"vi";}'),
('b3b10d83163188d5a80d9e4e3c05dd93', '::1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.155 Safari/537.36', 1439872003, 'a:2:{s:9:"user_data";s:0:"";s:5:"_lang";s:2:"vi";}');
...
(6, 'admin', 'e4cf5ee155834b38213504dfa2e2127d', 'Tạ Đình Tích', 'xM8542J73YyNQvFixwzi5w1YUpeIfNOUtUwUhFwOBCR9vwk8EIMxAIIr3X7b0X7PD30Ob', '2015-08-18 09:54:17', '2015-07-28 10:17:39', '2015-06-29 15:55:24', 'dinhtich91@gmail.com', '', '', '', 1),
...
(8, 'admin', 'd95d554cdbf0f71920ff42fa59e29a25d', '', 'YTQtqq1Z0kxkmSAIPoHQNjei3YCD1zRY7HWBDv0K6pyhouBEF1CFMRDG5y9C8oGR949tZ', '2015-08-18 09:54:17', '0000-00-00 00:00:00', '2015-08-12 22:07:20', 'abc@yahoo.com', '', '', '', 0),
(10, 'admin', '92d6809aa5b2a181b37c5385b067ba68', '', 'ou1fi06jkERpQAAu5BY8eiH5yCBAmdIzAAmpS0yX1umnE8QMgyocrsmT2gnKoFvJdH28B', '2015-08-18 09:54:17', '0000-00-00 00:00:00', '2015-08-13 08:13:42', 'abc@yahoo.com', '', '', '', 2),
...
--
-- Indexes for table `ci_adv`
--
ALTER TABLE `ci_adv`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ci_article_category`
--
ALTER TABLE `ci_article_category`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ci_article_item`
--
ALTER TABLE `ci_article_item`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ci_comment`
--
ALTER TABLE `ci_comment`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ci_partner`
--
ALTER TABLE `ci_partner`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ci_route`
--
ALTER TABLE `ci_route`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ci_adv`
--
ALTER TABLE `ci_adv`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `ci_article_category`
--
ALTER TABLE `ci_article_category`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `ci_article_item`
--
ALTER TABLE `ci_article_item`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `ci_comment`
--
ALTER TABLE `ci_comment`
...
--
-- AUTO_INCREMENT for table `ci_partner`
--
ALTER TABLE `ci_partner`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ci_route`
--
ALTER TABLE `ci_route`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `ci_tag`
--
ALTER TABLE `ci_tag`
